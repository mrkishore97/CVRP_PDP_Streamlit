...
def fetch_readme(repo_owner="mrkishore97", repo_name="CVRP_PDP_Streamlit"):
    try:
        ...
        if response.status_code == 200:
            ...
            return "README could not be loaded. Please check the repository URL."
    except Exception as e:
...
# Show README if the button is clicked
if st.session_state.show_readme:
    st.markdown(SAMPLE_README)
else:
    # Main content
    tab1, tab2, tab3, tab4, tab5 = st.tabs(["Locations", "Demands", "Vehicles", "Pickup-Delivery", "Solution"])
